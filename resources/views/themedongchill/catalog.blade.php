@extends('themes::themedongchill.layout')
...
@section('breadcrumb')
    ...
    @include('themes::themedongchill.inc.catalog_filter')
@endsection
        ...
        <div class="list-films film-new">
            <ul>
                @foreach ($data as $key => $movie)
                    ...
                    @endphp
                    @include('themes::themedongchill.inc.sections_movies_item')
                @endforeach
            </ul>

            <div class="clear"></div>
            <div class="pagination">
                {{ $data->appends(request()->all())->links('themes::themedongchill.inc.pagination') }}
            </div>
        </div>
    </div>
@endsection
