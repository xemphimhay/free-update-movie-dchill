@extends('themes::themedongchill.layout_episode')
@php
    $urls = [];
    $current_url = '';
    $next_url = '';
...
@section('content')
    <div class="left-content-player" id="player-video">
        ...
        <a style="background-color: #2E2E2E;border-radius:4px;color:#FFFFFF;padding:6px 8px;border:1px solid transparent;text-align:center;cursor:pointer;margin-right:5px;"
            href="{{$next_url}}">Tập tiếp &gt;&gt;</a>
            ...
            <div class="box-rating" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating">
                ...
                <div>
                    <div id="div_average" style="float: left; line-height: 16px; margin: 0 5px; ">
                        ...
                        điểm / <span id="rate_count" itemprop="ratingCount">{{ $currentMovie->getRatingCount() }}</span>
                        lượt)
                    </div>
