...
namespace Ophim\ThemeDongChill\Controllers;
...
class ThemeDongChillController
{
    ...
    public function index(Request $request)
    {
        if ($request['search'] || $request['filter']) {
            ...
            return view('themes::themedongchill.catalog', [
                'data' => $data,
                'search' => $request['search'],
                'section_name' => "Tìm kiếm phim: $request->search"
            ]);
        }
        return view('themes::themedongchill.index', [
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        return view('themes::themedongchill.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::themedongchill.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
